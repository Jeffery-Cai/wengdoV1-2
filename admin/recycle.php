...
{
// 删除函数
	delMore("del","wd_nav","article_id","./article.php");
}

// 查询
 $data=selectDb("SELECT * FROM wd_article LEFT JOIN wd_article_cate ON wd_article.article_cate_id=wd_article_cate.article_cate_id");
?>
<!doctype html>
<html lang="zh-ch">
	<!-- container-fluid -->
    ...
    <!-- 中间内容 -->
		<div id="content">
			...
			<div id="breadcrumb">
				...
				<a href=""><i class="icon-th-list"></i> 回收管理</a>
				<a href="article.php" class="current"><i class="icon-th-list"></i> 所有回收</a>
			</div>
